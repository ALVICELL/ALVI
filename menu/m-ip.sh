...
COLBG1="$(cat /etc/ALVICELL/theme/$colornow | grep -w "BG" | cut -d: -f2|sed 's/ //g')"
WH='\033[1;37m'
...
sleep 1
REQIP=$(curl -sS https://raw.githubusercontent.com/${USERGIT}/ip/main/ipmini | awk '{print $4}' | grep $daftar)
