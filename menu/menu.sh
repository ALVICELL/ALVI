...
Exp1=$(curl https://raw.githubusercontent.com/ALVICELL/ip/main/ipmini | grep $MYIP | awk '{print $3}')
if [[ $today < $Exp1 ]]; then
    sts="${Info}"
else
    sts="${Error}"
...
export sem=$( curl -s https://raw.githubusercontent.com/ALVICELL/ALVI/main/versi)
...
echo -e "${BIYellow}□ WHATSAPP            = ${IPurple}{ ${BIWhite}082183496832 ${IPurple}}${NC}"
echo -e "${BIYellow}□ AutoScript By       = ${IPurple}( ${BICyan}ALVI ${BIYellow}CELL ${BIWhite}TUNNELING ${IPurple})${NC}"

echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}"
echo -e "${BICyan} │                  ${BIWhite}ALVI ${BIYellow}CELL ${BICyan}TUNNELING ${NC}"
echo -e "${BICyan} | ${NC}"
echo -e " ${BICyan}│  ${BICyan}Use Core        :  ${IPurple}XRAY ${NC}"
echo -e " ${BICyan}│  ${BICyan}IP-VPS          :  ${BIYellow}$IPVPS ${NC}"
echo -e " ${BICyan}└─────────────────────────────────────────────────────┘${NC}"

echo -e "${BIYellow}  SEMOGA REJEKIMU LANCAR KAWAN, JANGAN LUPA BERSYUKUR ${NC}" 
