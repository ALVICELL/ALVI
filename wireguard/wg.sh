...
echo "Checking VPS"
IZIN=$( curl https://raw.githubusercontent.com/ALVICELL/ip/main/ipmini | grep $MYIP )
if [ $MYIP = $MYIP ]; then
...
echo -e "${NC}${LIGHT}WhatsApp : 082183496832
echo -e "${NC}${LIGHT}Telegram : https://t.me/Alvi_cell"
exit 0
fi
# ==================================================
# Link Hosting Kalian
tarapkuhing="raw.githubusercontent.com/ALVICELL/ALVI/sc/main/wireguard"
...
echo -e "${Info} Wireguard Script By ALVI CELL"
...
# Tambahan
cd /usr/bin
wget -O addwg "https://raw.githubusercontent.com/ALVICELL/ALVI/main/wireguard/addwg.sh"
wget -O delwg "https://raw.githubusercontent.com/ALVICELL/ALVI/main/wireguard/delwg.sh"
wget -O renewwg "https://raw.githubusercontent.com/ALVICELL/ALVI/main/wireguard/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x renewwg
cd
